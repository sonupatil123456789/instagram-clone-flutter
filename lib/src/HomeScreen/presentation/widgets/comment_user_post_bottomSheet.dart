...
class CommentUserPostBottomSheet extends StatelessWidget with ScreenUtils {
  PostEntity postData;
  ...
  Widget build(BuildContext context) {
    ...
    byDefaultCommentReplyedTo = byDefaultCommentReplyedTo.copyWith(
        uuid: postData.uuid,
        uniqueName: postData.uniqueName,
                    ...
                    child: SingleChildScrollView(
                      child: Padding(
                        ...
                        child: StreamBuilder(
                          stream: context
                              .read<HomeBloc>()
                              .getAllPostCommmentsStreamEvent(
                                  context, postData.postId.toString()),
                            ...
                            if (snapshot.connectionState ==
                              ...
                              return CommentTreeWidget<CommentsEntity,
                                ...
                                CommentsModel(
                                  ...
                                  commentMessage: postData.postDiscription ??
                                      "No Discription",
                                ),
                                snapshot.data!,
                                ...
                                contentChild: (context, comment) {
                                  return CommentCard(
                                    ...
                                    delete: (CommentsModel commentData) {
                                      showDeletDialogBox(context, commentData, postData);
                                    },
